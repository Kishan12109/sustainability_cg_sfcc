...
server.get('CarbonReport', server.middleware.https, function (req, res, next) {
    var profile = session.customer.profile;
    var carbonPointsConsumed = profile.custom.carbonPointsConsumed || 0;
    var carbonPointsNeutralized = profile.custom.carbonPointsNeutralized || 0;
    var pointsRemaining = (carbonPointsConsumed - carbonPointsNeutralized);
    res.render('carbon/carbonReport', {
        carbonPointsConsumed: carbonPointsConsumed,
        carbonPointsNeutralized: carbonPointsNeutralized,
