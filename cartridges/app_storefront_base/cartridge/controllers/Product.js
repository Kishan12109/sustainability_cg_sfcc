...
server.get('Show', cache.applyPromotionSensitiveCache, consentTracking.consent, function (req, res, next) {
    ...
    var sustainableThresholdValue = Site.getCurrent().getCustomPreferenceValue('sustainableThresholdValue');
    viewData.enableSustainability = enableSustainability;
    viewData.sustainableThresholdValue = sustainableThresholdValue;
